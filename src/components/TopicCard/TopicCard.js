    ...
    return (
        <div className="max-w-sm bg-white border border-sky-700 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-4">
            ...
            <div className="p-5 flex justify-between">
                ...
                <button onClick={() => handleNavigate(id)} className='inline-flex items-center p-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:outline-none dark:hover:bg-blue-700'>
